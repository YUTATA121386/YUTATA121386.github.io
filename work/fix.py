# Write the new generateProcessLog to a separate JS file first
js_func = r'''function generateProcessLog(state, dateStr) {
...
with open(r'C:\Users\beppi\Documents\Codex\YUTATA121386.github.io\work\new_func.js', 'w', encoding='utf-8') as f:
    f.write(js_func)
print("JS function written to file")
