...
.section-card.building {
  opacity: 0.55;
}
.section-card.building:hover {
  opacity: 0.8;
...
.section-card.ready:hover .card-arrow {
...
@media (max-width: 768px) {
  ...
  .VPHero .text { font-size: 0.8rem !important; letter-spacing: 3px; }
  .VPHero .tagline { font-size: 0.7rem !important; }
  .VPHero { padding: 2rem 1rem 1rem !important; }
  .home-sections { padding: 0 1rem 2rem; max-width: 100%; }
  .section-card { padding: 14px 14px; }
  .card-icon { font-size: 1.2rem; width: 30px; }
