...
export default defineConfig({
  ...
  themeConfig: {
    ...
    sidebar: {
      ...
      "/logs/": [{ text: "过程日志", items: [{ text: "概览", link: "/logs/" }] }],
      "/weekly/": [{ text: "周报", items: [{ text: "概览", link: "/weekly/" }] }],
      "/rules/": [{ text: "规则体系", items: [{ text: "概览", link: "/rules/" }, { text: "采集规则", link: "/rules/collection-rules" }, { text: "核查规则", link: "/rules/verification-rules" }, { text: "排版规范", link: "/rules/style-guide" }] }],
